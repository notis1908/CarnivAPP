...
public class InventoryScene {
    ...
    //private static final String PRODUCT_SIZE_COLUMN = "Product Size";
    ...
    private static TableView createInventoryTableView(final Inventory inventory, final User user, final Connection connection) {
        ...
        /*final TableColumn<Map.Entry<Product, Integer>, String> productSizeColumn = new TableColumn<>(PRODUCT_SIZE_COLUMN);
        productSizeColumn.setId(PRODUCT_SIZE_COLUMN);
        productSizeColumn.setCellValueFactory(item -> new SimpleStringProperty(item.getValue().getKey().getSize()));*/
        ...
        if (user instanceof Administrator) {
            table.getColumns().setAll(productNameColumn, /*productSizeColumn,*/ productWeightColumn, productPriceColumn, productAmountColumn, productTotalColumn);
            addDetailsRowExpander(table, inventory, ADMIN_ADD_PRODUCT_BUTTON, ADMIN_REMOVE_PRODUCT_BUTTON, ADMIN_ADD_PRODUCT_NOTIFICATION_SUCCESS,
                    ...
                    user, connection);
            addProductBox = createAddProductBox(productNameColumn, /*productSizeColumn,*/ productWeightColumn, productPriceColumn, productAmountColumn, inventory, items, user, connection);
        } else {
            table.getColumns().setAll(productNameColumn, /*productSizeColumn,*/ productWeightColumn, productPriceColumn, productAmountColumn);
    ...
    private static HBox createAddProductBox(final TableColumn productNameColumn, /*final TableColumn productSizeColumn,*/ final TableColumn productWeightColumn, final TableColumn productPriceColumn,
        ...
        /*final TextField addProductSize = new TextField();
        addProductSize.setPromptText("Enter size");
        addProductSize.setId("size");
        addProductSize.setMaxWidth(productSizeColumn.getPrefWidth());*/
        ...
        addNewProductButton.setOnMouseClicked(mouseEvent -> {
            ...
            //final String newProductSize = addProductSize.getText();
            ...
            if (!newProductName.isEmpty() /*&& !newProductSize.isEmpty()*/ && !newProductWeight.isEmpty() && !newProductPrice.isEmpty() && !newProductAmount.isEmpty()) {
                try {

                    final Product product = new Product(newProductName, /*newProductSize,*/ Double.parseDouble(newProductWeight), Double.parseDouble(newProductPrice));
        ...
        addProductBox.getChildren().addAll(addProductName, /*addProductSize,*/ addProductWeight, addProductPrice, addProductAmount, addNewProductButton);
