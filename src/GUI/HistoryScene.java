...
public class HistoryScene {
    private static final String ORDER_ADDRESS_COLUMN = "Διεύθυνση Παράδοσης";
    private static final String ORDER_TOTAL_PRICE_COLUMN = "Συνολικό Κόστος Παραγγελίας";
    private static final String TOTAL_ALL_ORDERS_COLUMN = "Σύνολο Παραγγελιών";
    private static final String EMPTY_COLUMN = "Κενό";

    public static BorderPane syncTablesIntoOneTable(final TableView orderTable, final TableView totalTable) {
        final BorderPane pane = new BorderPane();

        // Ένωση και συγχρονισμός πινάκων
    ...
    public static void syncScrollbars(final TableView orderTable, final TableView totalTable) {
        // Συγχρονισμός Μπάρας Για Scrolling
    ...
    public static TableView createOrderTableView(final List<Order> orders) {
        ...
        table.setId("Πίνακας Παραγγελιών");
        ...
        expander.setText("Λεπτομέρειες Παραγγελίας");
        expander.setId("Λεπτομέρειες Παραγγελίας");
    ...
    public static TableView createTotalOrderTableView(final List<Order> orders) {
        ...
        table.setId("Πίνακας Συνολικού Κόστους");
    ...
    private static ScrollBar findScrollBar(final TableView table, final Orientation orientation) {
        ...
        final Set<Node> set = table.lookupAll("Μπάρα Για Scrolling");
